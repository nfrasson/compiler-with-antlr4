...
public class FrassonGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "OP", "OP_AT", "OPREL", "ENQUANTO", 
			"FACA", "FIMENQUANTO", "ID", "NUM", "VIRG", "PV", "AP", "FP", "DP", "TEXTO", 
			"WS", "COMMENT"
		};
	}
	...
	public FrassonGrammarLexer(CharStream input) {
		super(input);
